 ...
 * <p>
 * Enum names of this enum themselves are represented by <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2">ISO
 * 3166-1 alpha-2</a> codes. There are instance methods to get the country name ({@link #getName()}), the <a
 * href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-3" >ISO 3166-1 alpha-3</a> code ({@link #getAlpha3()}) and the <a
 * href="http://en.wikipedia.org/wiki/ISO_3166-1_numeric">ISO 3166-1 numeric</a> code ({@link #getNumeric()}). In
 * addition, there are static methods to get a CountryCode instance that corresponds to a given alpha-2/alpha-3/numeric
...
public enum CountryCode {
   ...
   /**
    * <a href="http://en.wikipedia.org/wiki/South_Georgia_and_the_South_Sandwich_Islands">South Georgia and the South
    * Sandwich Islands</a>
    */
   ...
   /**
    * <a href="http://en.wikipedia.org/wiki/United_States_Minor_Outlying_Islands">United States Minor Outlying
    * Islands</a>
    */
   ...
   /**
    * @return The translation key for this country. The translation key is a composition of prefix <b>txt.countryCode.</b> and the enum name.
    *  </p>
    *  For example: <b>txt.countryCode.DE</b> for germany.
    */
   public String getTranslationKey () {
      return "txt.countryCode." + name();
   }
    ...
    *
    * @param code An ISO 3166-1 <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2" >alpha-2</a> or <a
    *        href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-3" >alpha-3</a> code.
