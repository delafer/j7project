...
public final class EmailValidator {
	 ...
	 * because for example, you only want users to enter in a raw address (<tt>john.smith@somewhere.com</tt> -
	 * no quotes or angle brackets), then change this constant to <tt>false</tt>.
	 *
	 * <p>
	 * Its default value is <tt>true</tt> to remain RFC 2822 compliant, but
	 * you should set it depending on what you need for your application.
	...
	public EmailValidator(String text) {
		super();
		setText(text);
	}
	 ...
	 *
	 * <p>
	 * Default is <tt>false</tt> for convenience's sake - if a bounced message
	 * is ever received for this address, this value should be set to
	...
	public boolean onEquals(EmailValidator o) {
		if (o instanceof EmailValidator) {
			EmailValidator ea = o;
	...
	/*
	 * public static void main(String[] args) { String addy = "\"John Smith\"
