...
//		long aaa = (long)convert((float)1.5, ByteUnit.TB, ByteUnit.Byte);
//		System.out.println(aaa);
		...
		f = 1f + ax.nextFloat();
		for (int i = 0; i < 106; i++) {
			a = (long)((double)a * (double)1.5d);
			System.out.println(a+ "           "+autoSize(a));
		}
		
		System.out.println(autoSize(21157846474l));
