...
public class JpegXL {
	...
	static {
		System.setProperty("jna.platform.library.path", "W:\\avif\\");
		System.setProperty("jna.library.path", "W:\\avif\\");
	}

    static {
//	    LibraryLoader.checkLibrary("jxl_threads", false);
//	    LibraryLoader.checkLibrary("jxl", false);
