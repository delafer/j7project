 ...
 */
public interface DecodeLibrary extends vavi.awt.image.jna.jpegxl.Library {
    ...
    //The library name used to search for JNA's native library may be altered by setting jna.boot.library.name, which defaults to "jnidispatch"
    //W32APIOptions.OPTION_OPEN_FLAGS
    //Native.setProtected(true)
    //To avoid the overhead of preserving the system last error information on every native call, invoke setPreserveLastError(false) or set the System property jna.preserve_last_error=false.
