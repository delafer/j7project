 ...
 * @author Heinz Doerr
 */
public class ResampleOpSlow extends AdvancedResizeOp
{
	...
	public ResampleOpSlow(int destWidth, int destHeight) {
		this(DimensionConstrain.createAbsolutionDimension(destWidth, destHeight));
	}

	public ResampleOpSlow(DimensionConstrain dimensionConstrain) {
